...
- Posture: ${gameState.finder.spatial.posture} (NOTE: Your posture adjusts automatically based on your location/target. E.g. interacting with the SAFE will make you CROUCH.)
